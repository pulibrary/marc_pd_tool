...
class TestWorkerFunctions:
    ...
    def test_init_worker_with_detector_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            copyright_dir = os.path.join(tmpdir, "copyright")
            renewal_dir = os.path.join(tmpdir, "renewal")
            
            os.makedirs(cache_dir)
            os.makedirs(copyright_dir)
            os.makedirs(renewal_dir)
    ...
    def test_process_batch_worker_not_initialized(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.pkl', delete=False) as f:
            batch_path = f.name
            pickle.dump([Publication(title="Test", source_id="001")], f)
...
class TestProcessBatchComprehensive:
    ...
    def test_process_batch_renewal_match_with_generic_title(self, tmp_path):
        ...
        mock_matcher.find_best_match.side_effect = [None, mock_match]  # No reg match, has renewal match
