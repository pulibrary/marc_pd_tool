# tests/test_processing/test_key_generation.py
...
class TestTitleKeys:
    ...
    def test_title_keys_empty(self):
        ...
        assert generate_wordbased_title_keys("") == set()
        assert generate_wordbased_title_keys("   ") == set()

        # Note: "the a an" will generate metaphone keys even if all words are stopwords
        keys = generate_wordbased_title_keys("the a an")
...
class TestAuthorKeys:
    ...
    def test_author_keys_last_first_format(self):
        ...
        keys = generate_wordbased_author_keys("Smith, John A.")
    ...
    def test_author_keys_first_last_format(self):
        ...
        keys = generate_wordbased_author_keys("John Smith")
    ...
    def test_author_keys_empty(self):
        ...
        assert generate_wordbased_author_keys("") == set()
        assert generate_wordbased_author_keys("   ") == set()
