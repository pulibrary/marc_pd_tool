...
class TestScoreAnalyzerComprehensive:
    ...
    def test_analyze_ground_truth_scores_basic(self):
        ...
        assert any(
            score < 100.0 for score in analysis.title_distribution.scores
        )  # Modified title for second
    ...
    def test_analyze_with_renewal_pairs(self):
        ...
        pairs = [
            GroundTruthPair(
                marc_record=marc, copyright_record=renewal, match_type="renewal", lccn="55001"
            )
        ]
    ...
    def test_analyze_with_mixed_pairs(self):
        ...
        marc1 = Publication(
            title="Book One", author="Author One", pub_date="1950", source_id="m001", lccn="50001"
        )
        marc1.normalized_lccn = "50001"
        marc1.year = 1950

        copyright1 = Publication(
            title="Book One", author="Author One", pub_date="1950", source_id="c001", lccn="50001"
        )
        copyright1.normalized_lccn = "50001"
        copyright1.year = 1950
        ...
        # Create renewal pair
        marc2 = Publication(
            title="Book Two", author="Author Two", pub_date="1955", source_id="m002", lccn="55001"
        )
        marc2.normalized_lccn = "55001"
        marc2.year = 1955

        renewal2 = Publication(
            title="Book Two", author="Author Two", pub_date="1955", source_id="r002", lccn="55001"
        )
        ...
        pairs = [
            ...
            GroundTruthPair(
                marc_record=marc2, copyright_record=renewal2, match_type="renewal", lccn="55001"
            ),
        ]
    ...
    def test_analyze_with_failed_matches(self):
        ...
        assert len(analysis.title_distribution.scores) == 0 or all(
            s < 50 for s in analysis.title_distribution.scores
        )
    ...
    def test_generate_analysis_report(self):
        ...
        distributions = [
            ScoreDistribution(field_name="title", scores=[100.0, 95.0, 90.0, 85.0, 80.0]),
            ScoreDistribution(field_name="author", scores=[100.0, 90.0, 80.0, 70.0, 60.0]),
            ScoreDistribution(field_name="publisher", scores=[90.0, 80.0, 70.0, 60.0, 50.0]),
            ScoreDistribution(field_name="combined", scores=[95.0, 85.0, 75.0, 65.0, 55.0]),
        ]
