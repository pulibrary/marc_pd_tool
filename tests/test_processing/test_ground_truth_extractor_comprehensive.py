...
class TestGroundTruthExtractorComprehensive:
    ...
    def test_extract_with_none_renewal_publications(self):
        ...
        pairs, stats = extractor.extract_ground_truth_pairs(
            [[marc_pub]], [copyright_pub], None  # This should trigger line 40
        )
    ...
    def test_extract_with_no_matches(self):
        ...
        marc_pub1 = Publication(
            title="Book 1", author="Author 1", pub_date="1950", source_id="m001", lccn="50012345"
        )
        marc_pub1.normalized_lccn = "50012345"
        marc_pub1.year = 1950

        marc_pub2 = Publication(
            title="Book 2", author="Author 2", pub_date="1975", source_id="m002", lccn="75012345"
        )
        ...
        pairs, stats = extractor.extract_ground_truth_pairs(
            [[marc_pub1, marc_pub2]], [copyright_pub], []
        )
    ...
    def test_extract_with_renewal_matches(self):
        ...
        extractor = GroundTruthExtractor()
        pairs, stats = extractor.extract_ground_truth_pairs(
            [[marc_pub]], [], [renewal_pub]  # No copyright records
        )
    ...
    def test_build_lccn_index(self):
        ...
        pubs = [
            ...
            Publication(
                title="Book 2", author="Author 2", pub_date="1960", source_id="002", lccn="60054321"
            ),
            Publication(
                title="Book 3",
                author="Author 3",
    ...
    def test_extract_with_both_copyright_and_renewal_matches(self):
        ...
        renewal_pub = Publication(
            title="Double Match Book", author="Author", pub_date="1955", source_id="R123456"
        )
        renewal_pub.lccn = "55012345"
        renewal_pub.normalized_lccn = "55012345"
        renewal_pub.year = 1955
    ...
    def test_empty_inputs(self):
        ...
        pairs, stats = extractor.extract_ground_truth_pairs(
            [], [], []  # No MARC batches  # No copyright records  # No renewal records
        )
    ...
    def test_invalid_ground_truth_pair(self):
        ...
        marc_pub = Publication(
            title="Test Book", author="Author", pub_date="1975", source_id="m001", lccn="75012345"
        )
        marc_pub.normalized_lccn = "75012345"
        marc_pub.year = 1975
        ...
        renewal_pub = Publication(
            title="Renewal Book", author="Author", pub_date="1975", source_id="r001"
        )
    ...
    def test_marc_without_lccn(self):
        ...
        extractor = GroundTruthExtractor()
        pairs, stats = extractor.extract_ground_truth_pairs(
            [[marc_with_lccn, marc_without_lccn]], [copyright_pub], []
        )
