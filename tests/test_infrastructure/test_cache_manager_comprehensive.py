...
class TestCacheManagerYearRangeOperations:
    ...
    def test_get_year_range_cache_filename_variations(self):
        ...
        # Both years
        filename = cache_mgr._get_year_range_cache_filename("publications", min_year=1950, max_year=1960)
    ...
    def test_get_cached_copyright_data_year_specific(self, tmp_path):
        ...
        cached = cache_mgr.get_cached_copyright_data(
            str(source_dir), min_year=1950, max_year=1959
        )
...
class TestCacheManagerIndexOperations:
    ...
    def test_get_cached_indexes_corrupt_file(self, tmp_path):
        ...
        result = cache_mgr.get_cached_indexes(
            "/dummy/copyright",
            "/dummy/renewal",
            "test_hash"
        )
...
class TestCacheManagerGenericDetector:
    ...
    def test_get_cached_generic_detector_disabled(self, tmp_path):
        ...
        result = cache_mgr.get_cached_generic_detector(
            "/dummy/copyright",
            "/dummy/renewal",
            config
        )
...
class TestCacheManagerMetadata:
    ...
    def test_clear_all_caches(self, tmp_path):
        ...
        # Create cache files
        for subdir in ["copyright_data", "renewal_data", "indexes", "marc_data", "generic_detector"]:
    ...
    def test_cache_directory_creation_failure(self):
        ...
        with patch('os.makedirs', side_effect=OSError("Permission denied")):
            with pytest.raises(OSError, match="Permission denied"):
                cache_mgr = CacheManager("/invalid/path")
