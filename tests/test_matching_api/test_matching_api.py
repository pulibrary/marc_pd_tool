...
from marc_pd_tool.matching_api import MatchingEngine, SimilarityCalculator, ScoreCombiner, SimilarityScores
...
class TestAbstractBaseClasses:
    ...
    def test_matching_engine_inheritance(self):
        ...
        class CompleteMatchingEngine(MatchingEngine):
            def find_best_match(self, marc_pub, copyright_pubs, title_threshold, author_threshold, 
...
class TestAPIContracts:
    ...
    def test_similarity_calculator_contract(self):
        ...
        assert calculator.calculate_publisher_similarity("Penguin", "", "Published by Penguin Books") == 75.0
        assert calculator.calculate_publisher_similarity("Penguin", "", "Published by Random House") == 25.0
