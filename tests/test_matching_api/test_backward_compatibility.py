...
class TestBackwardCompatibility:
    ...
    def test_publisher_scoring_compatibility(self):
        ...
        reg_pub = Publication("Test Title", "Smith, John", publisher="Penguin Books", pub_date="1950")
        result = find_best_match(
            marc_pub, [reg_pub], 80, 70, 2, 60, 95, 90, self.generic_detector
        )
        assert result is not None
        ...
        ren_pub = Publication(
            "Test Title", "Smith, John", pub_date="1950",
            source="Renewal", full_text="Published by Penguin Books in New York"
        )
        result = find_best_match(
            marc_pub, [ren_pub], 80, 70, 2, 60, 95, 90, self.generic_detector
        )
        assert result is not None
        assert result["similarity_scores"]["publisher"] >= 70
    ...
    def test_generic_title_detection_compatibility(self):
        ...
        marc_pub = Publication("Complete Works", "Smith, John", publisher="Penguin", pub_date="1950")
        copyright_pub = Publication("Complete Works", "Smith, John", publisher="Penguin", pub_date="1950")
    ...
    def test_thresholds_compatibility(self):
        ...
        marc_pub = Publication("Test Title", "Smith, John", publisher="Penguin", pub_date="1950")
        copyright_pub = Publication("Similar Title", "Jones, Bob", publisher="Random", pub_date="1950")
        ...
        marc_pub_better = Publication("Test Title", "Smith, John", publisher="Penguin", pub_date="1950")
        copyright_pub_better = Publication("Test Title", "Smith, John", publisher="Penguin", pub_date="1950")
        result = find_best_match(
    ...
    def test_full_title_usage_compatibility(self):
        ...
        copyright_pub = Publication("Main Title. Part 1. Introduction", "Smith, John", pub_date="1950")
    ...
    def test_result_structure_compatibility(self):
        ...
        expected_keys = ["marc_record", "copyright_record", "similarity_scores", "generic_title_info"]
        ...
        generic_keys = [
            "marc_title_is_generic", "copyright_title_is_generic", 
            "has_generic_title", "marc_detection_reason", "copyright_detection_reason"
        ]
    ...
    def test_empty_list_compatibility(self):
        ...
        result = find_best_match(
            marc_pub, [], 80, 70, 2, 60, 95, 90, self.generic_detector
        )
