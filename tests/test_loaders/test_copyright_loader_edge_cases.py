...
class TestCopyrightLoaderSpecialCases:
    ...
    def test_extract_from_entry_unicode_handling(self):
        ...
        assert pub.title == "la bibliotheque francaise"  # Title normalized to lowercase and ASCII folded
        assert pub.author == "rene descartes"  # Author normalized to lowercase and ASCII folded  
        assert pub.publisher == "editions gallimard"  # Publisher normalized to lowercase and ASCII folded
