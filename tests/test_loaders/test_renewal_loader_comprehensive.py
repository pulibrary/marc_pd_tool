...
Normal Row\tNormal Author\tA234567\t1951-01-01\tR00002\t1978-01-01\tAnother Claimant\tNormal full text"""
    ...
    def test_load_all_renewal_data_mixed_files(self, tmp_path):
        ...
        (tmp_path / "renewals.tsv").write_text("title\tauthor\toreg\todat\tentry_id\trdat\tclaimants\tfull_text\n")
...
Tōkyō Story\t小津 安二郎\tA234567\t1953-01-01\tR00002\t1980-01-01\t松竹株式会社"""
        ...
        assert publications[0].title == "la bibliotheque"  # Title normalized to lowercase and ASCII folded
        assert publications[0].author == "rene descartes"  # Author normalized to lowercase and ASCII folded
    ...
    def test_very_large_file_simulation(self, tmp_path):
        ...
        with open(tsv_file, 'w') as f:
            ...
            # Write many rows
            for i in range(1000):
                f.write(f"Book {i}\tAuthor {i}\tA{i:06d}\t1950-01-01\tR{i:06d}\t1977-01-01\tClaimant {i}\n")
