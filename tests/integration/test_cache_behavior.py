...
class TestCacheBehavior:
    ...
    def test_cache_creation_and_reuse(
        self,
        small_marc_file: Path,
        ...
        analyzer1 = MarcCopyrightAnalyzer(
        ...
        with patch.object(analyzer1.cache_manager, 'cache_indexes') as mock_save:
            with patch.object(analyzer1.cache_manager, 'get_cached_indexes') as mock_get:
                ...
                with patch.object(analyzer1, '_load_and_index_data', side_effect=mock_load_and_index):
    ...
    def test_year_specific_caching(
        self,
        medium_marc_file: Path,
        temp_output_dir: Path
    ):
