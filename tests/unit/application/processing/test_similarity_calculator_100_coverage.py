# tests/unit/application/processing/test_similarity_calculator_100_coverage.py
...
class TestSimilarityCalculatorEdgeCases:
    ...
    def test_calculate_title_similarity_no_abbreviation_expansion(self):
        ...
        score = calculator.calculate_title_similarity("Test Co. Ltd.", "Test Co. Ltd.")
        assert score > 0
    ...
    def test_calculate_title_similarity_no_stemming(self):
        ...
        score = calculator.calculate_title_similarity(
            "Running books quickly", "Running books quickly"
        )
...
class TestCalculatorConfiguration:
    ...
    def test_all_features_disabled(self):
        ...
        title_score = calculator.calculate_title_similarity(
            "The Running Books Co.", "The Running Books Co."
        )
        author_score = calculator.calculate_author_similarity("Smith, J.", "Smith, J.")
        publisher_score = calculator.calculate_publisher_similarity(
            "Random House Inc.", "Random House Inc.", copyright_full_text=""
        )
    ...
    def test_mixed_configurations(self):
        ...
        score = calculator.calculate_title_similarity(
            "Test Co. Publications", "Test Company Publications"
        )
...
class TestPublicationObjectHandling:
    ...
    def test_calculate_similarity_with_publications(self):
        ...
        marc_pub = Publication(
            title="Test Book", author="Test Author", publisher="Test Publisher", source_id="001"
        )

        copyright_pub = Publication(
            title="Test Book", author="Test Author", publisher="Test Publisher", source_id="c001"
        )

        # Calculate similarities using publication attributes
        title_score = calculator.calculate_title_similarity(marc_pub.title, copyright_pub.title)
        author_score = calculator.calculate_author_similarity(
            marc_pub.author or "", copyright_pub.author or ""
        )
        publisher_score = calculator.calculate_publisher_similarity(
            marc_pub.publisher or "", copyright_pub.publisher or "", copyright_full_text=""
        )
...
class TestEdgeCasesWithSpecialCharacters:
    ...
    def test_titles_with_special_characters(self):
        ...
        score = calculator.calculate_title_similarity(
            "Test & Co., Inc.", "Test and Company, Incorporated"
        )
    ...
    def test_empty_fields_handling(self):
        ...
        publisher_score = calculator.calculate_publisher_similarity(
            "", "Test Publisher", copyright_full_text=""
        )
...
class TestLanguageSpecificProcessing:
    ...
    def test_non_english_processing(self):
        ...
        score = calculator.calculate_title_similarity(
            "Le Grand Livre", "Le Grand Livre", language="fre"
        )
        assert score == 100.0
    ...
    def test_language_fallback(self):
        ...
        score = calculator.calculate_title_similarity(
            "The Book", "The Book", language="jpn"  # Not supported
        )
        assert score == 100.0
