# marc_pd_tool/api/_export.py

"""Export mixin for exporting analysis results"""
...
class ExportAnalyzerProtocol(Protocol):
    """Protocol defining required attributes for ExportMixin"""

    results: "AnalysisResults"


class ExportMixin:
    """Mixin for exporting analysis results"""
    ...
    def get_statistics(self: ExportAnalyzerProtocol) -> dict[str, int]:
        ...
        return dict(self.results.statistics)
